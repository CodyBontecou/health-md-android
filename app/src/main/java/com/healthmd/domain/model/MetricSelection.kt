...
private val UNAVAILABLE_METRICS: List<UnavailableHealthMetricDefinition> = listOf(
    // iOS parity ledger: Apple-exclusive and Health Connect-unavailable signals.
    ...
    UnavailableHealthMetricDefinition(
        ...
        "Apple Watch electrodermal-activity hardware; Health Connect has no equivalent record.",
    ),
    UnavailableHealthMetricDefinition(
        "heart_rate_recovery",
        HealthMetricCategory.HEART,
        "Heart Rate Recovery",
        "Apple Watch-derived recovery metric; Health Connect does not expose a matching daily aggregate.",
    ),
    UnavailableHealthMetricDefinition(
        "afib_burden",
        HealthMetricCategory.HEART,
    ...
    UnavailableHealthMetricDefinition(
        ...
        "HealthKit State of Mind mood valence is iOS 17+/Apple-platform specific and is not exposed by Health Connect.",
    ),
    UnavailableHealthMetricDefinition(
        "momentary_emotions",
        HealthMetricCategory.MINDFULNESS,
    ...
    UnavailableHealthMetricDefinition(
        ...
        "Stand Time",
        "Apple Stand Time has no Health Connect 1.1.0-beta02 equivalent record.",
    ),
    UnavailableHealthMetricDefinition(
        "move_time",
        HealthMetricCategory.ACTIVITY,
        "Move Time",
        "Apple Move Time has no Health Connect 1.1.0-beta02 equivalent record; Android exports Exercise Minutes instead.",
    ),
    UnavailableHealthMetricDefinition(
        "physical_effort",
        HealthMetricCategory.ACTIVITY,
        "Physical Effort",
        "Health Connect 1.1.0-beta02 does not expose Apple physical-effort records.",
    ),
    UnavailableHealthMetricDefinition(
    ...
    UnavailableHealthMetricDefinition(
        ...
        "Medications",
        "Health Connect 1.1.0-beta02 does not expose a medication dose-event catalog comparable to HealthKit medications.",
    ),
    UnavailableHealthMetricDefinition(
        "uv_exposure",
    ...
    UnavailableHealthMetricDefinition(
        ...
        HealthMetricCategory.OTHER,
        "Time in Daylight",
        "Health Connect 1.1.0-beta02 does not expose HealthKit Time in Daylight records.",
    ),
    UnavailableHealthMetricDefinition(
        "number_of_falls",
        HealthMetricCategory.OTHER,
    ...
    UnavailableHealthMetricDefinition(
        ...
        HealthMetricCategory.MINDFULNESS,
        "State of Mind Count",
        "Legacy Android alias for State of Mind entries; Health Connect has no equivalent record.",
    ),
    UnavailableHealthMetricDefinition(
    ...
    UnavailableHealthMetricDefinition(
        ...
        HealthMetricCategory.MINDFULNESS,
        "Daily Mood Count",
        "Legacy Android alias for State of Mind daily mood; Health Connect has no equivalent record.",
    ),
    UnavailableHealthMetricDefinition(
    ...
    UnavailableHealthMetricDefinition(
        ...
        HealthMetricCategory.ACTIVITY,
        "Stand Hours",
        "Legacy Android label for Apple Stand Time; Health Connect has no equivalent record.",
    ),
    UnavailableHealthMetricDefinition(
        "move_minutes",
        HealthMetricCategory.ACTIVITY,
        "Move Minutes",
        "Legacy Android label for Apple Move Time; Health Connect has no equivalent record.",
    ),
    UnavailableHealthMetricDefinition(
